...
def lazystr(text):
	...
	from flex.helpers.uzi import force_text  # Avoid circular import
...
class SlotLessLazyObject(object):
	"""
...
class LazyObject(object):
	...
	def __set_self_attr__(self, name, value):
		super(LazyObject, self).__setattr__(name, value)

	def __setattr__(self, name, value):
		if name == "_wrapped":
			self.__set_self_attr__(name, value)
		else:
			if self._wrapped is empty:
				self._setup()
			setattr(self._wrapped, name, value)
...
class SimpleLazyObject(LazyObject):
	...
	def __init__(self, func):
		...
		self.__set_self_attr__('_setupfunc', func)
